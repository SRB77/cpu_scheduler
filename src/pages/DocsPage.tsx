...
// Documentation Topics Navigation
const topics = [
...
export function DocsPage() {
  ...
  const currentContent = docsContent[activeTopic];
            ...
            <div className="grid grid-flow-row auto-rows-max text-sm gap-1">
              {topics.map((topic) => (
                <button
                  ...
                  className={`flex w-full items-center rounded-md border border-transparent px-2 py-1.5 hover:underline focus:outline-none text-left ${
          ...
          <div className="mx-auto w-full min-w-0">
            {currentContent ? (
              ...
              <div className="text-center py-20 text-muted-foreground">
                Select a topic from the sidebar reading.
              </div>
            )}
          </div>
